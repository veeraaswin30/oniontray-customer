...
public abstract class StoreProdReviewAdapter<ReviewList> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public abstract void onBindViewHolderImpl(RecyclerView.ViewHolder viewHolder, StoreProdReviewAdapter<ReviewList> adapter, int i);

    public abstract RecyclerView.ViewHolder onCreateViewHolderImpl(ViewGroup viewGroup, StoreProdReviewAdapter<ReviewList> adapter, int i);

    public abstract int getItemCountImpl(StoreProdReviewAdapter<ReviewList> adapter);
...
//                Log.e("StoReviewBanner", "onFailure");
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int i) {
        if (mHeader != null) {
            ...
            onBindViewHolderImpl(viewHolder, this, i - 2);
        } else {
        ...
        if (mOnClickEvent != null) {
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    mOnClickEvent.onClick(v, holder.getAdapterPosition() - (mHeader == null ? 0 : 2));
                }
            });
        }
    ...
    public StoreProdReviewAdapter(List<ReviewList> data, Context context) {
        mData = data;
        mContext = context;

    }

    public List<ReviewList> getData() {
        return mData;
    }

    public void setData(List<ReviewList> data) {
        mData = data;
        notifyDataSetChanged();
    }

    public void addItem(ReviewList item, int position) {
        mData.add(position, item);
        notifyItemInserted(position + (mHeader == null ? 0 : 1));
    }

    public void removeItem(ReviewList item) {
