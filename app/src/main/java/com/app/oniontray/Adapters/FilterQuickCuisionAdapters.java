...
import static com.app.oniontray.Activites.StoreFilterActivity.resetTxt;
...
//        Log.e("string", stringBuilder.toString());
    ...
    public FilterQuickCuisionAdapters(Context context, List<FilterCategoryList> categoryList) {
        ...
        Log.e("CategortLIst", categoryList.toString());
    }
    ...
    public void onBindViewHolder(final FilterQuickCuisionAdapters.FilterViewHolder holder, final int position) {
      ...
      /*  resetTxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                holder.cuisinesSingleton.mRemoveAll();
                holder.cuisinesSingleton.mRemoveAllFilter();
            }
        });*/
    ...
    private void setfilterCuisineList(final FilterViewHolder holder, final int position) {
        ...
        if (holder.cuisinesSingleton.getArray() != null &&
            ...
            Log.e("CuisinesArray", holder.cuisinesSingleton.getArray().toString());
            Log.e("CuisinesId", filterCuisineList.get(position).getId());
        ...
        /*if (CusineListHashMap.containsKey("" +filterCuisineList.get(position).getUrlKey())) {
            Log.e("IF", "IFINPOS");
            holder.filter_quick_name_check_box_view.setChecked(true);
...
//                        holder.filter_quick_name_txt_view.setTextColor(Color.parseColor(loginPrefManager.getThemeColor()));
    ...
    private void setfilterCategoryList(final FilterViewHolder holder, final int position) {
        Log.e("CateId", filterCategoryList.get(position).getId().toString());
        if (holder.cuisinesSingleton.getFilterArray() != null &&
                !holder.cuisinesSingleton.getFilterArray().isEmpty()) {
            Log.e("CateArray", holder.cuisinesSingleton.getFilterArray().toString());
            Log.e("CateId", filterCategoryList.get(position).getId().toString());
            for (int i = 0; i < holder.cuisinesSingleton.getFilterArray().size(); i++) {
                Log.e("getIn", "getIn");
                if (holder.cuisinesSingleton.getFilterArray().get(i).contains(filterCategoryList.get(position).getUrlKey().toString())) {
                    Log.e("IFIN", "IFIN");
                    holder.filter_quick_name_check_box_view.setChecked(true);
                }
            }
...
//        }
        ...
        holder.root_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (holder.filter_quick_name_check_box_view.isChecked()) {
                    holder.filter_quick_name_check_box_view.setChecked(false);
                    holder.cuisinesSingleton.removeToFilterArr(filterCategoryList.get(position).getUrlKey().toString());
                    //mTempList.remove(cuisineList.id.toString())
                    Log.e("ArrToStr", filterCategoryList.get(position).getId().toString());
//                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
//                        holder.filter_quick_name_check_box_view.setButtonTintList(colorStateList);
//                    }
//                    holder.filter_quick_name_check_box_view.setHighlightColor(Color.parseColor(loginPrefManager.getThemeColor()));
                    ...
                    //Log.e("List", filterCuisineList.toString());
                    holder.cuisinesSingleton.addToFilterArray(filterCategoryList.get(position).getUrlKey().toString());
                    Log.e("ArrToStr", filterCategoryList.get(position).getUrlKey().toString());
                    holder.filter_quick_name_check_box_view.setChecked(true);
//                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
//                        holder.filter_quick_name_check_box_view.setButtonTintList(colorStateList);
//                    }
//                    holder.filter_quick_name_check_box_view.setHighlightColor(Color.parseColor(loginPrefManager.getThemeColor()));
    ...
    public class FilterViewHolder extends RecyclerView.ViewHolder {
        ...
        public CheckBox filter_quick_name_check_box_view;
