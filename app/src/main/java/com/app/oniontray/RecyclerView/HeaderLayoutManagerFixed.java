...
public class HeaderLayoutManagerFixed extends RecyclerView.LayoutManager {
     ...
     */
    private HeaderLayoutManagerFixed(Context context, int orientation, boolean reverseLayout) {
     ...
     */
    private void setStackFromEnd(boolean stackFromEnd) {
    ...
    private int findOneVisibleChild(int fromIndex, int toIndex, boolean completelyVisible) {
