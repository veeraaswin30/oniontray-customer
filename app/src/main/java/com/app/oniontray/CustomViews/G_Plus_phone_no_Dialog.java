...
public class G_Plus_phone_no_Dialog extends Dialog {
    ...
    public G_Plus_phone_no_Dialog(@NonNull Context context, Integer error_code, String email_id, String phone_no, String error_msg) {
        super(context);
    ...
    public G_Plus_phone_no_Dialog(@NonNull Context context, @StyleRes int themeResId) {
        super(context, themeResId);
    }

    protected G_Plus_phone_no_Dialog(@NonNull Context context, boolean cancelable, @Nullable OnCancelListener cancelListener) {
...
//                ValidateEmailAndMobile();
        ...
        if (error_code == 0) {
            ...
            fb_gp_dialog_tit_txt_view.setText(context.getString(R.string.gp_login_phone_desc_txt));

        } else if (error_code == 2) {

            user_crede_miss_match_txt_view.setVisibility(View.VISIBLE);
            user_crede_miss_match_txt_view.setText("" + error_msg);

            inputLayoutEmail.setVisibility(View.VISIBLE);
            input_phone_no_lay.setVisibility(View.VISIBLE);
            fb_gp_dialog_tit_txt_view.setText(context.getString(R.string.gp_login_email_phone_desc_txt));
            ...
            fb_gp_dialog_tit_txt_view.setText(context.getString(R.string.gp_login_email_desc_txt));
    ...
    private void ValidateEmailAndMobile() {
        ...
        CheckFaceBookUserCredientials(email_id_value, "" + fb_mobile_det_txt.getText().toString().replaceAll("\\s+", ""));

//        if (gp_login_dialog_interface != null) {
//
//            gp_login_dialog_interface.GP_Ok_Button_Method("" + fb_mobile_det_txt.getText().toString());
//
//        }
    ...
    private void ValidateEmailID() {
        ...
        CheckFaceBookUserCredientials(email_id_value, "" + phone_no);
    ...
    private void ValidatePhoneNo() {
        ...
        CheckFaceBookUserCredientials(email_id, "" + fb_mobile_det_txt.getText().toString().replaceAll("\\s+", ""));

    }


    private void CheckFaceBookUserCredientials(final String email_id, final String phone_no) {
        ...
        try {
            ...
            apiService.CheckSocialUserCredientialsReqMethod("" + loginPrefManager.getStringValue("Lang_code"),
                    "" + context.getString(R.string.user_type_google), "" + email_id, "" + phone_no).enqueue(new Callback<SocUserCredReqResp>() {
                @Override
                public void onResponse(Call<SocUserCredReqResp> call, Response<SocUserCredReqResp> response) {
                    ...
                    try {
                        ...
                        if (response.body().getResponse().getHttpCode() == 200) {
                            ...
                            if (gp_login_dialog_interface != null) {
                                gp_login_dialog_interface.GP_Ok_Button_Method(email_id, phone_no);
                            }
                            ...
                            if (response.body().getResponse().getCode() == 2) {
                                ...
                                if (gp_login_dialog_interface != null) {
                                    ...
                                    gp_login_dialog_interface.GP_Verify_Email_Phone_Error_Method(2, email_id, phone_no, "" + response.body().getResponse().getMessage());
                                ...
                                if (gp_login_dialog_interface != null) {
                                    ...
                                    gp_login_dialog_interface.GP_Verify_Email_Phone_Error_Method(3, email_id, phone_no, "" + response.body().getResponse().getMessage());
                                ...
                                if (gp_login_dialog_interface != null) {
                                    ...
                                    gp_login_dialog_interface.GP_Verify_Email_Phone_Error_Method(4, email_id, phone_no, "" + response.body().getResponse().getMessage());
    ...
    public interface GP_Login_Dialog_Interface {
        ...
        void GP_Ok_Button_Method(String email_id, String mobile_no);

        void GP_Verify_Email_Phone_Error_Method(Integer error_coder, String email_id, String phone_no, String error_msg);
