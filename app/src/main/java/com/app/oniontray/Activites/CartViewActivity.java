...
public class CartViewActivity  extends LocalizationActivity implements MycartAdapter.MyCartsUpdateInterface {
    ...
    private void redirectInto(String type) {
        if (myCartAdapter != null && myCartAdapter.getItemCount() != 0) {
            ...
            if (min_order_amt > mproduct_total_price) {
                showExitWarningDialog(CartViewActivity.this);
            } else {

                if (loginPrefManager.getStringValue("user_id").isEmpty()) {

                    Intent signin_intent = new Intent(CartViewActivity.this, RestaurantSignInSignUpActivity.class);
                    ...
                    if (type.equals("takeaway"))
                        checkout = new Intent(CartViewActivity.this, DeliveryActivity.class);
                    else
                        checkout = new Intent(CartViewActivity.this, PickUpActivity.class);
            ...
            Toast.makeText(CartViewActivity.this, "" + getString(R.string.my_carts_err_msg_when_cart_empty_txt), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void intializeView() {
        ...
        String language = String.valueOf(LanguageSetting.getLanguage(CartViewActivity.this));
        ...
        restaurant_mycart_recycler_view.setLayoutManager(new LinearLayoutManager(CartViewActivity.this));
        restaurant_mycart_recycler_view.addItemDecoration(new ProdListItemOffsetDecor(CartViewActivity.this, R.dimen.prod_list_item_row_line_height));
...
//        LocalBroadcastManager.getInstance(CartViewActivity.this).sendBroadcast(intent_rece);
    ...
    public void MyCheckOutCallMethod() {
        if (loginPrefManager.getStringValue("user_id") != null && !loginPrefManager.getStringValue("user_id").isEmpty()) {
            startActivity(new Intent(CartViewActivity.this, MyFavouritesActivity.class));
        } else {
...
//            Log.e("total", "" + productRespository.totalPrice());
            ...
            myCartAdapter = new MycartAdapter(CartViewActivity.this, productRespository.getCartProductList());
            myCartAdapter.MyCartsinterfaceCallMethod(CartViewActivity.this);
            ...
            public void onResponse(Call<VendorDetailForMyCart> call, final Response<VendorDetailForMyCart> response) {
                ...
                try {
                    ...
                    if (response.body().getResponse().getHttpCode() == 200) {
                        ...
                        Toast.makeText(CartViewActivity.this, response.body().getResponse().getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void AddMoreClickEvent() {
        ...
        restaurant_add_more.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent productIntent = new Intent(CartViewActivity.this, ProductMenuItemListWithDynamicTabs.class);
                ...
                if (myCartAdapter != null && myCartAdapter.getItemCount() != 0) {
                    ...
                    if (min_order_amt > mproduct_total_price) {
                        ...
                        if (loginPrefManager.getStringValue("user_id").isEmpty()) {
                            ...
                            Intent proceedToCheck = new Intent(CartViewActivity.this, ProceedToCheckActivity.class);
